...
In addition the previously discussed set of Bash commands, Git Bash includes the full set of Git core commands discussed through out this site. Learn more at the corresponding documentation pages for [git clone](#git-clone), [git commit](#git-commit), [git checkout](#git-checkout), [git push](#git-push), and more.
